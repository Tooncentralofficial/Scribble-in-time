        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/about-us" className="text-white font-semibold">About Us</a>
              <a href="#" className="text-white hover:text-gray-200 transition-colors">Pricing</a>
              <a href="#" className="text-white hover:text-gray-200 transition-colors">FAQs</a>
          ...
          {isMobileMenuOpen && (
            <div className="md:hidden mt-4 bg-black bg-opacity-90 rounded-lg p-4">
              <div className="flex flex-col space-y-4">
                ...
                <a href="/about-us" className="text-white font-semibold py-2">About Us</a>
                <a href="#" className="text-white hover:text-gray-200 transition-colors py-2">Pricing</a>
                <a href="#" className="text-white hover:text-gray-200 transition-colors py-2">FAQs</a>
                <button className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors w-full mt-4">
                  Get Started
                </button>
              </div>
            </div>
