        ...
        <div className="container mx-auto px-4 sm:px-6 pb-12 sm:pb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-8 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16">
            ...
            <div className="sm:col-span-2 lg:col-span-2 text-center sm:text-left">
              <div className="mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-4" style={{ fontFamily: 'serif', fontStyle: 'italic' }}>
                  A Scribble in Time
                </h3>
              ...
              <div className="flex space-x-3 justify-center sm:justify-start">
                <a href="#" className="w-10 h-10 sm:w-8 sm:h-8 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-colors">
                  <span className="text-white text-sm sm:text-xs">X</span>
                </a>
                <a href="#" className="w-10 h-10 sm:w-8 sm:h-8 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors">
                  <span className="text-white text-sm sm:text-xs">f</span>
                </a>
                <a href="#" className="w-10 h-10 sm:w-8 sm:h-8 bg-pink-600 rounded-full flex items-center justify-center hover:bg-pink-500 transition-colors">
                  <span className="text-white text-sm sm:text-xs">@</span>
                </a>
                <a href="#" className="w-10 h-10 sm:w-8 sm:h-8 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
                  <span className="text-white text-sm sm:text-xs">in</span>
                </a>
              </div>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-2 text-gray-300 text-sm">
                <li><a href="#" className="hover:text-white transition-colors block py-1">Service</a></li>
                <li><a href="#" className="hover:text-white transition-colors block py-1">Testimonials</a></li>
                <li><a href="#" className="hover:text-white transition-colors block py-1">Portfolios</a></li>
                <li><a href="#" className="hover:text-white transition-colors block py-1">Writers</a></li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-2 text-gray-300 text-sm">
                <li><a href="#" className="hover:text-white transition-colors block py-1">Packages</a></li>
                <li><a href="/how-it-works" className="hover:text-white transition-colors block py-1">How it works</a></li>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-2 text-gray-300 text-sm">
                ...
                <li><a href="#" className="hover:text-white transition-colors block py-1">Newsletter</a></li>
              </ul>
            </div>

            {/* Newsletter Subscription */}
            <div className="sm:col-span-2 lg:col-span-1 text-center sm:text-left">
              <h4 className="text-white font-semibold mb-4 text-base">Subscribe to our Newsletter</h4>
